...
class HeroAbilityWizardModal extends HTMLElement {
  constructor() {
    super();
...
if (typeof customElements !== 'undefined')
  customElements.define('hero-ability-wizard-modal', HeroAbilityWizardModal);

export default HeroAbilityWizardModal;
