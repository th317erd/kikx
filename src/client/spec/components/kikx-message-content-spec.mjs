...
describe('kikx-message-content', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('kikx-message-content');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('kikx-message-content');
    assert.ok(registered, 'kikx-message-content should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/kikx-message-content/kikx-message-content.mjs');
