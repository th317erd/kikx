...
describe('kikx-interaction', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('kikx-interaction');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('kikx-interaction');
    assert.ok(registered, 'kikx-interaction should be registered as a custom element');
  });
