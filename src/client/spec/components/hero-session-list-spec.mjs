...
function registerComponent() {
  ...
  class HeroSessionList extends JsdomHTMLElement {
  ...
  dom.window.customElements.define('hero-session-list', HeroSessionList);
}
...
describe('hero-session-list', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('hero-session-list');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('hero-session-list');
    assert.ok(registered, 'hero-session-list should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/hero-session-list/hero-session-list.mjs');
