...
function registerComponent() {
  ...
  class HeroCreateSessionModal extends JsdomHTMLElement {
    constructor() {
      super();
  ...
  dom.window.customElements.define('hero-create-session-modal', HeroCreateSessionModal);
}
...
describe('hero-create-session-modal', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('hero-create-session-modal');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('hero-create-session-modal');
    assert.ok(registered, 'hero-create-session-modal should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/hero-create-session-modal/hero-create-session-modal.mjs');
