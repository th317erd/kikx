...
function registerComponent() {
  ...
  dom.window.customElements.define('kikx-ability-wizard-modal', KikxAbilityWizardModal);
}
...
describe('kikx-ability-wizard-modal', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('kikx-ability-wizard-modal');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('kikx-ability-wizard-modal');
    assert.ok(registered, 'kikx-ability-wizard-modal should be registered as a custom element');
  });
