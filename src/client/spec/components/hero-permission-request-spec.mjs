...
function registerComponent() {
  ...
  class HeroPermissionRequest extends JsdomHTMLElement {
  ...
  dom.window.customElements.define('hero-permission-request', HeroPermissionRequest);
}
...
describe('hero-permission-request', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('hero-permission-request');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('hero-permission-request');
    assert.ok(registered, 'hero-permission-request should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/hero-permission-request/hero-permission-request.mjs');
