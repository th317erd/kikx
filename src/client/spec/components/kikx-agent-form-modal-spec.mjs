...
function registerComponent() {
  ...
  class KikxAgentFormModal extends JsdomHTMLElement {
  ...
  dom.window.customElements.define('kikx-agent-form-modal', KikxAgentFormModal);
}
...
describe('kikx-agent-form-modal', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('kikx-agent-form-modal');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('kikx-agent-form-modal');
    assert.ok(registered, 'kikx-agent-form-modal should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/kikx-agent-form-modal/kikx-agent-form-modal.mjs');
