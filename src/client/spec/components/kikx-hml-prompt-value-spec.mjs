...
function registerComponent() {
  ...
  dom.window.customElements.define('kikx-hml-prompt-value', KikxHmlPromptValue);
}
...
describe('kikx-hml-prompt-value', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('kikx-hml-prompt-value');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('kikx-hml-prompt-value');
    assert.ok(registered, 'kikx-hml-prompt-value should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/kikx-hml-prompt-value/kikx-hml-prompt-value.mjs');
