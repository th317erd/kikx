...
function registerComponent() {
  ...
  class HeroSidebar extends JsdomHTMLElement {
    constructor() {
      super();
  ...
  dom.window.customElements.define('hero-sidebar', HeroSidebar);
}
...
describe('hero-sidebar', () => {
  ...
  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('hero-sidebar');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('hero-sidebar');
    assert.ok(registered, 'hero-sidebar should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/hero-sidebar/hero-sidebar.mjs');
