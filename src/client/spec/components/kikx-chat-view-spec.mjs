...
function registerComponent() {
  ...
  dom.window.customElements.define('kikx-chat-view', KikxChatView);
}
...
describe('kikx-chat-view', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('kikx-chat-view');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('kikx-chat-view');
    assert.ok(registered, 'kikx-chat-view should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/kikx-chat-view/kikx-chat-view.mjs');
