...
function registerComponent() {
  ...
  class HeroScrollAnchor extends JsdomHTMLElement {
    constructor() {
      super();
  ...
  dom.window.customElements.define('hero-scroll-anchor', HeroScrollAnchor);
}
...
describe('hero-scroll-anchor', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('hero-scroll-anchor');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('hero-scroll-anchor');
    assert.ok(registered, 'hero-scroll-anchor should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/hero-scroll-anchor/hero-scroll-anchor.mjs');
