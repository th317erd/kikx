...
function registerComponent() {
  ...
  class HeroWebsocketManager extends JsdomHTMLElement {
    constructor() {
      super();
  ...
  dom.window.customElements.define('hero-websocket-manager', HeroWebsocketManager);
}
...
describe('hero-websocket-manager', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('hero-websocket-manager');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('hero-websocket-manager');
    assert.ok(registered, 'hero-websocket-manager should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/hero-websocket-manager/hero-websocket-manager.mjs');
