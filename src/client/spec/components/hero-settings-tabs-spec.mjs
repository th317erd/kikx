...
function registerComponent() {
  ...
  class HeroSettingsTabs extends JsdomHTMLElement {
    constructor() {
      super();
  ...
  dom.window.customElements.define('hero-settings-tabs', HeroSettingsTabs);
}
...
describe('hero-settings-tabs', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('hero-settings-tabs');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('hero-settings-tabs');
    assert.ok(registered, 'hero-settings-tabs should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/hero-settings-tabs/hero-settings-tabs.mjs');
