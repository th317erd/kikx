...
// wrapper since jsdom does not have kikx-modal registered. The tab switching,
...
function registerComponent() {
  ...
  class KikxAbilityListModal extends JsdomHTMLElement {
  ...
  dom.window.customElements.define('kikx-ability-list-modal', KikxAbilityListModal);
}
...
describe('kikx-ability-list-modal', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('kikx-ability-list-modal');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('kikx-ability-list-modal');
    assert.ok(registered, 'kikx-ability-list-modal should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/kikx-ability-list-modal/kikx-ability-list-modal.mjs');
