...
function registerComponent() {
  ...
  class HeroModal extends JsdomHTMLElement {
  ...
  dom.window.customElements.define('hero-modal', HeroModal);
}
...
describe('hero-modal', () => {
  ...
  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('hero-modal');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('hero-modal');
    assert.ok(registered, 'hero-modal should be registered as a custom element');
  });
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/hero-modal/hero-modal.mjs');
