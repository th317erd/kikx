...
export function setup({ registerTool, PluginInterface }) {
  ...
  function getHookHandlers(context, hookName) {
    let registry = context && context.getProperty
    ...
    return registry.getHookHandlers(hookName);
  }
  ...
  // Register both tools
  registerTool('websearch:fetch',  WebsearchFetchTool);
  registerTool('websearch:search', WebsearchSearchTool);
