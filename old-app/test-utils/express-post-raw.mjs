#!/usr/bin/env node
/**
 * Express POST route WITHOUT express.json() middleware
 * Read body manually to test if it's express.json() or POST causing issues
 */
'use strict';
...
// NO express.json() - we'll read body manually

// POST route but manually reading body
app.post('/stream', async (req, res) => {
  ...
  const content = parsed.content || 'Say hi';
...
const server = app.listen(PORT, () => {
  console.log(`Express POST (raw body) test at http://localhost:${PORT}`);
