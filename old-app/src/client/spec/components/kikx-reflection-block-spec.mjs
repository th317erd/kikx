...
describe('kikx-reflection-block', () => {
  let element;

  beforeEach(() => {
    setupDOM();
    element = dom.window.document.createElement('kikx-reflection-block');
  ...
  it('registers as a custom element', () => {
    let registered = dom.window.customElements.get('kikx-reflection-block');
    assert.ok(registered, 'kikx-reflection-block should be registered as a custom element');
  });
  ...
  it('expanded attribute starts the block expanded', () => {
    ...
    let expandedElement = dom.window.document.createElement('kikx-reflection-block');
  ...
  it('real module exports a class constructor', async () => {
    ...
    try {
      let mod = await import('../../components/kikx-reflection-block/kikx-reflection-block.mjs');
