...
import { KikxStepModal, GlobalState, DynamicProperty, formatErrors } from '../kikx-step-modal/kikx-step-modal.js';

export class KikxModalConfigureAbility extends KikxStepModal {
  static tagName = 'kikx-modal-configure-ability';
...
KikxModalConfigureAbility.register();
