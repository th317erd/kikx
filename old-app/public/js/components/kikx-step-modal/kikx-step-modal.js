...
/**
 * Kikx Step Modal Base Class
 *
 * Extends KikxModal with multi-step functionality:
 * - Declarative steps via <kikx-step> elements
...
import { KikxModal, GlobalState, escapeHtml, MODAL_STYLES, DynamicProperty } from '../kikx-modal/kikx-modal.js';
...
// ============================================================================
// KikxStepModal Base Class
// ============================================================================

/**
 * Base class for multi-step modal components.
 * Uses declarative <kikx-step> elements for step content.
 *
 * @example
 * class MyStepModal extends KikxStepModal {
 ...
 * }
 */
export class KikxStepModal extends KikxModal {
  static tagName = 'kikx-step-modal';
  ...
  /**
   * Update visibility of kikx-step elements based on current step.
   * Uses visibility: hidden so all steps contribute to modal sizing.
   */
  _updateStepVisibility() {
    let heroSteps = this.querySelectorAll('kikx-step');
  ...
  _renderContent() {
    ...
    // Create kikx-step elements
    for (let i = 0; i < steps.length; i++) {
      let step = steps[i];
      let heroStep = document.createElement('kikx-step');
  ...
  async openModal() {
    ...
    requestAnimationFrame(() => {
      let firstInput = this.querySelector('kikx-step:first-of-type input, kikx-step:first-of-type select, kikx-step:first-of-type textarea');
      if (firstInput)
        firstInput.focus();
    });
  }
