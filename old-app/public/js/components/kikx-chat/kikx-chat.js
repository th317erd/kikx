...
/**
 * Kikx Chat - Message Display Component
 *
 * Displays:
...
export class KikxChat extends KikxComponent {
  static tagName = 'kikx-chat';
   ...
   */
  get framesProvider() {
    // Look for provider in ancestors (light DOM parent since kikx-chat is in shadow DOM of chat view)
   ...
   */
  _getScrollContainer() {
    // Check if kikx-chat itself has overflow (scrollHeight > clientHeight)
