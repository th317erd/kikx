...
/**
 * Kikx Base Component Infrastructure
 *
 * Provides:
 * - GlobalState: App-wide reactive state via DynamicProperty
 * - KikxComponent: Base class for all Kikx UI components
 */
...
// ============================================================================
// KikxComponent Base Class
// ============================================================================

/**
 * Base class for all Kikx UI components.
 * Extends MythixUIComponent with Kikx-specific conveniences.
 */
export class KikxComponent extends MythixUIComponent {
  /**
