...
/**
 * Kikx Status Bar - Bottom Status Bar Component
 *
 * Displays:
...
// ============================================================================
// KikxStatusBar Component
// ============================================================================

export class KikxStatusBar extends KikxComponent {
  static tagName = 'kikx-status-bar';
  ...
  // ---------------------------------------------------------------------------
  // Shadow DOM (override KikxComponent default of Light DOM)
  // ---------------------------------------------------------------------------
  ...
  mounted() {
    ...
    document.addEventListener('kikx:authenticated', this._onAuthenticated);
    document.addEventListener('kikx:logout', this._onLogout);
  ...
  unmounted() {
    ...
    if (this._onAuthenticated) {
      document.removeEventListener('kikx:authenticated', this._onAuthenticated);
    }
    if (this._onLogout) {
      document.removeEventListener('kikx:logout', this._onLogout);
    }
    if (this._onStorage) {
