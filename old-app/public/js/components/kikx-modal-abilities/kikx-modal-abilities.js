...
/**
 * Kikx Modal Abilities
 * Modal for viewing and managing abilities.
 */

import { KikxModal, GlobalState, escapeHtml } from '../kikx-modal/kikx-modal.js';

export class KikxModalAbilities extends KikxModal {
  static tagName = 'kikx-modal-abilities';
  ...
  async _editAbility(id) {
    let abilityModal = document.querySelector('kikx-modal-configure-ability');
    if (abilityModal) {
