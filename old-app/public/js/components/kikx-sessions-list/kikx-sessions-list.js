...
// ============================================================================
// KikxSessionsList Component
// ============================================================================

export class KikxSessionsList extends MythixUIComponent {
  static tagName = 'kikx-sessions-list';
  ...
  mounted() {
    ...
    if (!GlobalState) {
      console.warn('[kikx-sessions-list] GlobalState not available');
      return;
    }
   ...
   */
  showNewSessionModal() {
    this.dispatchEvent(new CustomEvent('kikx:show-modal', {
