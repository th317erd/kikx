...
/**
 * Kikx Main Controls - Header Action Buttons Component
 *
...
// ============================================================================
// KikxMainControls Component
// ============================================================================

export class KikxMainControls extends KikxComponent {
  static tagName = 'kikx-main-controls';
  ...
  logout() {
    this._dispatchMenuAction();
    this.dispatchEvent(new CustomEvent('kikx:logout', {
      bubbles: true,
      composed: true,
    }));
  }
  ...
  clearMessages() {
    this._dispatchMenuAction();
    this.dispatchEvent(new CustomEvent('kikx:clear-messages', {
      bubbles: true,
      composed: true,
    }));
  }
   ...
   */
  _dispatchMenuAction() {
    this.dispatchEvent(new CustomEvent('kikx:menu-action', {
      bubbles: true,
      composed: true,
    }));
  }
  ...
  handleShowHiddenToggle(event) {
    this.dispatchEvent(new CustomEvent('kikx:toggle-hidden', {
