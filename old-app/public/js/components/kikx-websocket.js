...
/**
 * Kikx WebSocket - Connection Handler Component
 *
 * Manages:
...
// ============================================================================
// KikxWebSocket Component
// ============================================================================

export class KikxWebSocket extends KikxComponent {
  static tagName = 'kikx-websocket';
  ...
  mounted() {
    ...
    // Listen for connect/disconnect events from kikx-app (events bubble UP to document)
  ...
  connect() {
    ...
    // Build WebSocket URL (nginx proxies /kikx/ws to server's /ws)
...
if (typeof customElements !== 'undefined') {
  customElements.define(KikxWebSocket.tagName, KikxWebSocket);
}
