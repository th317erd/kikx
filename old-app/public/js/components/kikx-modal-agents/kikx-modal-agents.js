...
export class KikxModalAgents extends KikxModal {
  static tagName = 'kikx-modal-agents';
  ...
  _openConfig(agentId) {
    let configModal = document.querySelector('kikx-modal-agent-settings');
    if (configModal) {
