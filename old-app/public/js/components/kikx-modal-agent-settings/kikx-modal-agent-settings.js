...
/**
 * Kikx Modal Agent Settings
 * Modal for editing agent configuration JSON.
 */

import { KikxModal, GlobalState } from '../kikx-modal/kikx-modal.js';

export class KikxModalAgentSettings extends KikxModal {
  static tagName = 'kikx-modal-agent-settings';
...
KikxModalAgentSettings.register();
