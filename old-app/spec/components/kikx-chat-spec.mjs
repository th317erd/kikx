/**
 * Tests for kikx-chat.js
 *
 * Tests KikxChat component:
...
describe('CHAT-SRC: kikx-chat.js source integrity', () => {
  let source;

  beforeEach(() => {
    source = fs.readFileSync('public/js/components/kikx-chat/kikx-chat.js', 'utf8');
  });
