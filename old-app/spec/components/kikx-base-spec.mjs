/**
 * Tests for kikx-base.js
 *
 * Tests GlobalState and KikxComponent base class.
...
describe('KikxComponent', () => {
  ...
  beforeEach(() => {
    ...
    // Create KikxComponent class
    KikxComponent = class extends MockMythixUIComponent {
      get global() {
        return GlobalState;
      }
  ...
  it('should provide access to GlobalState via global getter', () => {
    let component = new KikxComponent();
